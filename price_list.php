...
<html lang="pt-br">
  <head>
    ...
    <link href="../Projeto Integrador II/estilo/css/price_style.css" rel="stylesheet">
    <title>Preços</title>
  </head>
      ...
      <footer class="pt-4 my-md-5 pt-md-5 border-top">
        <div class="row">
          <div class="col-12 col-md">
            ...
            <small class="d-block mb-3 text-muted">&copy; Copyright: Rudi Júnior - GTI 2020</small>
          </div>
